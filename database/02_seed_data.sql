...
-- ============================================================
-- CATATAN: Password di bawah adalah hash dari "password123"
...
VALUES
    ('d1b2c3d4-0001-0001-0001-000000000001', 'admin', 'Administrator Sistem', 'admin@kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG');

-- Insert Dosen (3 data)
INSERT INTO dosen (id, nidn, nama, email, password_hash, bidang_keahlian, max_mahasiswa_bimbingan)
VALUES
    ('a1b2c3d4-0001-0001-0001-000000000001', '0101018001', 'Dr. Budi Santoso, M.Kom', 'budi.santoso@kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG', 'Sistem Informasi', 20),
    ('a1b2c3d4-0002-0002-0002-000000000002', '0202029002', 'Dr. Siti Rahayu, M.T', 'siti.rahayu@kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG', 'Rekayasa Perangkat Lunak', 15),
    ('a1b2c3d4-0003-0003-0003-000000000003', '0303030003', 'Prof. Ahmad Fauzi, Ph.D', 'ahmad.fauzi@kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG', 'Kecerdasan Buatan', 25);

-- Insert Mahasiswa (5 data)
INSERT INTO mahasiswa (id, nim, nama, email, password_hash, semester, jurusan, dosen_pa_id)
VALUES
    ('b1b2c3d4-0001-0001-0001-000000000001', '2021001001', 'Andi Pratama', 'andi.pratama@student.kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG', 5, 'Teknik Informatika', 'a1b2c3d4-0001-0001-0001-000000000001'),
    ('b1b2c3d4-0002-0002-0002-000000000002', '2021001002', 'Budi Wijaya', 'budi.wijaya@student.kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG', 5, 'Teknik Informatika', 'a1b2c3d4-0001-0001-0001-000000000001'),
    ('b1b2c3d4-0003-0003-0003-000000000003', '2021001003', 'Citra Dewi', 'citra.dewi@student.kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG', 3, 'Sistem Informasi', 'a1b2c3d4-0002-0002-0002-000000000002'),
    ('b1b2c3d4-0004-0004-0004-000000000004', '2022001001', 'Dian Permata', 'dian.permata@student.kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG', 3, 'Sistem Informasi', 'a1b2c3d4-0002-0002-0002-000000000002'),
    ('b1b2c3d4-0005-0005-0005-000000000005', '2022001002', 'Eko Saputra', 'eko.saputra@student.kampus.ac.id', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMeSSqRTaEIQECdKV9p0F2IaOG', 1, 'Teknik Informatika', 'a1b2c3d4-0003-0003-0003-000000000003');
